                  ...
                  {projects[activeProject].images && projects[activeProject].images.length > 1 ? (
                    <div className="relative">
                      <div className="h-96 bg-black rounded-lg overflow-hidden">
                        <div className={currentProject.type === "엔터테인먼트" ? "h-full overflow-y-auto scrollbar-thin scrollbar-thumb-green-400 scrollbar-track-gray-800" : "h-full flex items-center justify-center"}>
                          {!imageLoadError ? (
                            <img
                              src={currentProject.images[currentImageIndex]}
                              alt={`${currentProject.title} 스크린샷 ${currentImageIndex + 1}`}
                              className={currentProject.type === "엔터테인먼트" ? "w-full object-contain object-top" : "w-full h-full object-cover"}
                              loading="lazy"
